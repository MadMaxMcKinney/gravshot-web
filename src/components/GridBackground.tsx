...
export default function GridBackground({ gridSize = 28, gridLineColor = "#d7d9db", gridLineWidth = 1, backgroundColor = "transparent", className = "", children }: GridBackgroundProps) {
